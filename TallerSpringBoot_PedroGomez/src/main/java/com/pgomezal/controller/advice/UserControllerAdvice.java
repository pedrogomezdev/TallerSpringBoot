...
public class UserControllerAdvice extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleConflict(UserValidationException exception, WebRequest request) {
		String errorResponse = "Falta el nombre y/o la fecha de nacimiento.";
